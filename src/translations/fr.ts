export const fr = {
  ...
  added: "Added",
  add_to_channel:
    "Voulez-vous ajouter {{nom_d'utilisateur}} à {{nom_du_canal}} ?",
  delete_from_channel:
    "Voulez-vous supprimer {{nom_d'utilisateur}} de {{nom_du_canal}} ?",
  invite: "Invite",
  discover: "Découvrir",
  ...
  error_message_username_regex:
    "Username cannot be a combination of special characters and digits",
  ...
  how_to_enable:
    "Allez dans les paramètres pour activer le stockage de fichiers",
  ...
  permissions_microphone_android:
    "ChatXO a besoin d'accéder à votre microphone",
  ...
  max_username_chars:
    "Le nom d'utilisateur doit comporter 20 caractères maximum",
  ...
  signUpSucc_message:
    "Merci pour votre inscription ! Votre compte est maintenant prêt à être utilisé. ",
  ...
  block_user_dialog:
    "Voulez-vous bloquer {{nom_utilisateur}} dans {{nom_du_canal}} ?",
  unblock_user_dialog:
    "Voulez-vous débloquer {{nom_d'utilisateur}} sur {{nom_du_canal}} ?",
  block_user_button: "Block user",
  unblock_user_button: "Unblock",
  blocked_user_anuthorized:
    "Vous avez été bloqué dans le groupe. Veuillez contacter l'administrateur",
  ...
  error_fb_auth_get_user:
    "Une erreur s'est produite lors de l'obtention d'informations sur l'utilisateur",
  ...
  newAdmin: "New Admin",
  newAdminDescription:
    'Voulez-vous désigner {{nom}} comme nouvel administrateur dans le chat "{{canal}}" ?',
  ...
  group_is_private:
    "Seul l'administrateur du chat peut inviter un nouveau participant",
  group_is_open: "Tout utilisateur du chat peut inviter un nouveau participant",
  join_private_group:
    "Vous essayez de rejoindre le groupe privé. Veuillez contacter l'administrateur du groupe",
