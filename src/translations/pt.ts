export const pt = {
  ...
  delete_from_channel:
    "Deseja remover {{{nome_de_canal}} de {{{nome_do_canal}}?",
  invite: "Convidar",
  discover: "Descobrir",
  ...
  error_message_username_min:
    "Nome de utilizador deve ter pelo menos 3 caracteres",
  error_message_username_regex:
    "nome de utilizador não pode ser uma combinação de caracteres e dígitos especiais",
  ...
  signUpSucc_message:
    "Obrigado por seu registro! Sua conta está pronta para ser usada.",
  ...
  blocked_user_anuthorized:
    "Você foi bloqueado no grupo. Por favor, entre em contato com o administrador",
  ...
  newAdminDescription:
    'Você deseja definir {{name}} como um novo administrador em "{{channel}}" chat?',
  ...
  group_is_private:
    "Somente o administrador do chat pode convidar um novo participante",
