export const en = {
  ...
  delete_from_channel:
    "Do you want to remove {{username}} from {{channelName}}?",
  invite: "Invite",
  discover: "Discover",
  ...
  permissions_storage_read_android_message:
    "The app needs access to your file storage so you can play the file'",
  permissions_microphone_android: "ChatXO needs access to your microphone",
  permissions_microphone_android_message:
    "The app needs access to your microphone so you can record a file",
  ...
  unblock_user_dialog:
    "Do you want to unblock {{username}} in {{channelName}}?",
  block_user_button: "Block user",
  unblock_user_button: "Unblock",
  blocked_user_anuthorized:
    "You were blocked in the group. Please, contact the administrator",
  ...
  overlayDesc:
    "Here you can set the minimum relevance users need to have to be able to read your messages",
  ...
  newAdmin: "New Admin",
  newAdminDescription:
    'Do you want to set {{name}} as a new admin in "{{channel}}" chat?',
  ...
  join_private_group:
    "You are trying to join the Private group. Please, contact the Administrator of the group",
