export const it = {
  ...
  error_message_username_regex:
    "Il nome utente non può essere una combinazione di caratteri speciali e cifre",
  ...
  error_message_password_min:
    "La password dovrebbe essere lunga almeno 8 caratteri",
  ...
  permissions_microphone_android:
    "ChatXO ha bisogno di accedere al tuo microfono",
  ...
  signUpSucc_message:
    "Grazie per la tua registrazione! Il tuo account è ora pronto per l'uso.",
  ...
  blocked_user_anuthorized:
    "Sei stato bloccato nel gruppo. Per favore, contatta l'amministratore",
  ...
  error_fb_auth_get_user:
    "Ho ricevuto un errore durante il recupero delle informazioni sull'utente",
  ...
  newAdminDescription:
    'Vuoi impostare {{name}} come nuovo amministratore in "{{channel}}" chat?',
  ...
  group_is_private:
    "Solo l'amministratore della chat può invitare un nuovo partecipante",
  group_is_open:
    "Qualsiasi utente della chat può invitare un nuovo partecipante",
  join_private_group:
    "Stai tentando di unirti al gruppo privato. Per favore, contatta l'amministratore del gruppo",
