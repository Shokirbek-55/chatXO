export const de = {
  ...
  added: "hinzugefügt",
  add_to_channel:
    "Möchtest du {{username}} zur Gruppe {{channelName}} hinzufügen?",
  delete_from_channel:
    "Möchtest du {{username}} von der Gruppe {{channelName}} entfernen?",
  invite: "Einladen",
  discover: "Entdecken",
  ...
  error_message_username_regex:
    "Username darf keine Kombination aus Sonderzeichen und Ziffern sein",
  ...
  how_to_enable:
    "Gehe zu den Einstellungen, um die Dateispeicherung zu aktivieren",
  how_to_enable_microphone:
    "Gehe zu den Einstellungen, um das Mikrofon zu aktivieren",
  ...
  signUpSucc_message:
    "Danke für deine Registrierung! Dein Konto ist jetzt einsatzbereit.",
  ...
  unblock_user_dialog:
    "DMöchtest du {{username}} in {{channelName}} nicht mehr blockieren?",
  block_user_button: "User blockieren",
  unblock_user_button: "Nicht mehr blockieren",
  blocked_user_anuthorized:
    "Du wurdest in der Gruppe blockiert. Bitte wenden Sie sich an den Administrator",
  ...
  reset_alert_msg:
    "Überprüfen Sie Ihre E-Mail, es wird ein neues Passwort geben.",
  ...
  delete_from_friends:
    "Möchtest du {{username}} von deinen Freunden entfernen?",
  ...
  newAdminDescription:
    'Möchtest du {{name}} als neuen Administrator im "{{channel}}"-Chat festlegen?',
  ...
  group_is_private:
    "Nur der Admin des Chats kann einen neuen Teilnehmer einladen",
  group_is_open:
    "Jeder Benutzer des Chats kann einen neuen Teilnehmer einladen",
  join_private_group:
