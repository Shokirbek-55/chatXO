...
const NewAdmin = () => {
    ...
    return (
        ...
        >
            <Header leftIcon="arrowLeft" text={t('newAdmin')} onLeftIconPress={() => closeModal('right')} />
            <div>
                            ...
                            return (
                                <motion.div variants={item} key={index} id="map-dev">
                                    <RowItemView
                                        ...
                                        rightButton={true}
                                        text={e.username}
                                        className={e.id === user.id ? styles.old : styles.new}
                                        title={`${e.id === user.id ? t('admin') : t('newAdmin')}`}
