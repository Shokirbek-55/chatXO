...
const EditChannel = () => {
    ...
    const { closeModal, setCurrentRoute, toRouterManageCh, closeRightSideBar } = useRootStore().routerStore;
    ...
    return (
        <div className={styles.editChannel}>
            <Header leftIcon="arrowLeft" text={t('editGroup')} onLeftIconPress={() => closeModal('right')} />
            <div className={styles.content}>
                ...
                >
                    <Slider className={styles.slider} onChange={e => setUpdateChannelState('defaultRelevance', e)} />
                </div>
                ...
                <div className={styles.btnSave}>
                    ...
                    />
                    <ButtonComponent text="Save" width="100%" clickMe={updateChannelEvent} />
                </div>
            </div>
        </div>
    );
