...
const CreateChannel = () => {
    ...
    const { closeModal, openRightSideBar, toRouterManageCh, setCurrentRoute, toRouter } = useRootStore().routerStore;
        ...
        <div className={styles.container}>
            ...
            <div className={styles.contentBox}>
                ...
                <div className={styles.contentBottom}>
                    ...
                    <ButtonComponent width="100%" margin="10px 0 0 0" text="Create new group" clickMe={CreateChannel} />
                </div>
            </div>
        </div>
    );
