...
const CollectUsers = () => {
    ...
    const { collectUserList, setCollectUser, usersListForAdd } = useRootStore().friendsStore;
    ...
    return (
        <div>
            <Header text={`${t('addParticipant')}`} leftIcon="arrowLeft" onLeftIconPress={() => closeModal('left')} />
            <div className={styles.searchBox}>
                <SearchInput onChange={() => {}} placeholder={`${t('searchPlaceholder')}`} />
            </div>
                            ...
                            return (
                                <motion.div variants={item} key={index} id="map-dev" className={styles.channelRowBox}>
                                    <RowItemView
                                        ...
                                        rightButton={true}
                                        onButtonPress={() => setCollectUser(e.id as never)}
