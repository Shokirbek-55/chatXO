...
const BlockUser = () => {
    ...
    const { unblockUser, getBlockedUser, channelData, adminId } = useRootStore().channelStore;
    ...
    return (
        <div>
            <Header text={t('block_user_button')} leftIcon="arrowLeft" onLeftIconPress={() => closeModal('right')} />
