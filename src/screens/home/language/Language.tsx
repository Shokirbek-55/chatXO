    ...
    return (
        <div className={styles.container}>
            <div className={styles.contentBox}>
                <Header text={t('change_language')} leftIcon="arrowLeft" onLeftIconPress={() => closeModal('left')} />
                <div>
                    {Object.keys(lngs).map((lng, index) => (
                        <div className={styles.language} key={index}>
                            ...
                            <label
                                ...
                                onClick={e => i18n.changeLanguage(lng)}
                            >
                                <div className={styles.languagesName}>{lngs[lng as keyof typeof lngs].nativeName}</div>
                            </label>
                        </div>
                    ))}
                </div>
