...
const ReplyMessage = () => {
	const { setReplyMessage, editMessage, clearReplyMessage, setMessageText } =
	...
	function renderReplayMessage(message: RawMessage) {
		...
		if (message.type === "text") {
			...
			switch (message.type) {
				...
				case "document":
					LeftIconArea = (
						<DocumentIcon size={30} padding={0} color={Colors.BaliHai} hoverActive={false} />
					);
					break;
				case "audio":
					LeftIconArea = (
						<VideoPlayIcon size={30} padding={0} color={Colors.BaliHai} hoverActive={false} />
					);
					break;
				case "NORMAL":
					LeftIconArea = (
						<ChartIcon size={30} padding={0} color={Colors.BaliHai} hoverActive={false} />
					);
					break;
				case "RELEVANCE":
					LeftIconArea = (
