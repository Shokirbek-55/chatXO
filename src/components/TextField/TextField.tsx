...
const TextFieldd = ({ label, showClick, icon, showPass = false, visibility = false, ...props }: any) => {
    ...
    return (
        <div className={styles.textFieldContainer}>
            ...
            <div className={styles.passwordInput}>
                ...
                {visibility ? (
                    showPass ? (
                        <BiShow className={styles.showHide} onClick={showClick} />
                    ) : (
                        <BiHide className={styles.showHide} onClick={showClick} />
                    )
                ) : null}
            </div>
            {/* @ts-ignore */}
