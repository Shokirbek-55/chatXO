...
import { CoppyIcon, EditIcon, SearchIcon, ShareIcon, UsersBlock, UsersInfo } from '../../utils/icons';
...
const ChannelItems: FC<Props> = ({ text, icon, link, disable, iconSize = 18, textSize = 15, onClickItem }) => {
    return (
