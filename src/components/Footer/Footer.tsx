...
const Footer: FC = () => {
    ...
    return (
        <div className={styles.container}>
            <Button
                style={{
                    backgroundColor: currentRoute.id === 1 ? Colors.Yellow : 'transparent',
                }}
            ...
            <Button
                style={{
                    backgroundColor: currentRoute.id === 2 ? Colors.Yellow : 'transparent',
                }}
            ...
            <Button
                style={{
                    backgroundColor: currentRoute.id === 3 ? Colors.Yellow : 'transparent',
                }}
