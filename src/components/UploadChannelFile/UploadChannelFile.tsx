...
const UploadChannelFile = () => {
    ...
    const { closeSelectImage, cropAvatarState, onCreateChannelImage, createChannelAvatar } =
    ...
    const onCropComplete = (_, croppedAreaPixels) => {
        try {
            const croppedImage = getCroppedImg(cropAvatarState.img, croppedAreaPixels);
    ...
    return (
        <div className={styles.container} style={{ display: visible.chUploadFile ? 'block' : 'none' }}>
