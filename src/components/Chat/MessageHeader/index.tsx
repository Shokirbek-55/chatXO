import { CSSProperties, Dispatch, ReactNode, SetStateAction, useEffect, useMemo, useState } from 'react';
...
const MessageHeader = ({ message, name, color = '', showReply, userId, setPimp, children, titleOnPress }: Props) => {
