...
export const RenderMessage = ({ message }: PropType) => {
    const renderTextMessage = (message: RawMessage) => <LinkPriviewComponent message={message} />;

    const renderImageMessage = (message: RawMessage) => <MessageImg message={message} />;

    const renderVideoMessage = (message: RawMessage) => <MessageVideo message={message} />;

    const renderAudioMessage = (message: RawMessage) => (
        <MessageAudio message={message} users={undefined} position={undefined} />
    );
    ...
    const renderPollMessage = (message: RawMessage) => <MessagePoll message={message} />;
