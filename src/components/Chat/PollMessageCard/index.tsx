...
const PollMessageCard = () => {
    ...
    return (
        <div className={styles.container} style={{ display: visible.pollMesssageCard ? 'block' : 'none' }}>
            <div className={styles.closeCard} onClick={() => hide('pollMesssageCard')}>
                <CloserNoCirculIcon size={24} color="#fff" />
            </div>
            <div className={styles.content}>
                <div className={styles.titleBox}>
                    <Text children="New poll" />
                    <Text children={isCheck ? 'By relevance' : 'By Normal'} fontSize="14px" />
                </div>
                <div>
                    ...
                    <Text
                        ...
                        children={`you can add
                            ...
                            more option`}
                    />
                    <ButtonComponent text="+ Add an option" clickMe={() => addPollOption()} />
                    <Text margin="15px 0 5px 0" fontSize="15px" children={'Show result by relevance'} />
                    <Switch onChange={onChange} />
                    <div className={styles.backOrCreate}>
                        <ButtonComponent backColor="red" text="cancel" clickMe={cancelPollMessage} />
