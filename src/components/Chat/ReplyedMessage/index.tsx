...
const RepliedMessage: FC<Props> = ({ message, position, users }) => {
    ...
    const positionMessage = position ? { justifyContent: 'flex-end' } : { justifyContent: 'flex-start' };

    const messageHeaderIsPosition = position ? { display: 'none' } : { display: 'block', justifyContent: 'flex-end' };
            ...
            <div className={styles.originMessageCard} style={positionMessage}>
                <div style={messageHeaderIsPosition}>
                    <span onClick={() => handleRelevenceModal()}>
                        <MessageHeader name={message.username} color={message.color} message={message} />
                    </span>
                </div>
                <div className={styles.replyMessageBox}>
                    ...
                    <div className={styles.replyMessageCard} style={{ boxShadow: boxShadov }}>
                        <MessageHeader
